            ...
            <div className='flex gap-7 shadow-md rounded-2xl p-4 mb-10'>
                ...
                <div className='w-[75%] space-y-0'>   
                    <div className='flex gap-3 mb-3'>
                        <p className='py-1 px-3 border rounded-3xl text-sm bg-green-100 text-green-900'>Available</p>
                        <p className='py-1 px-3 border rounded-3xl text-sm bg-blue-100 text-blue-900'>{workingExperience}</p>
                    </div>
